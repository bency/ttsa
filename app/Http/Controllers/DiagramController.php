...
class DiagramController extends Controller
{
    ...
    public function accidentRatio()
    {
        ...
        $columns = [
            $axis,
            ['2008', 0.07, 0.27, 0.04, 0.26, 0.21, 0.03, 0.6, 0.94, 0.1, 0.01, 0.24, 0.01, 0.44, 0.04, 3.08, 0.55, 40.91, 0.4, 9.27, 0.2, 0.07, 72.23, 14.48, 0.5, 0, 0.01, 0, 0.05, 0.01, 0.06, 0.01, 0.05,],
            ['2009', 0.06, 0.29, 0.02, 0.24, 0.21, 0.03, 0.58, 0.87, 0.07, 0, 0.21, 0.01, 0.43, 0.04, 3.18, 0.63, 43.88, 0.44, 9.82, 0.19, 0.05, 80.54, 13.95, 0.21, 0, 0, 0, 0.05, 0.01, 0.07, 0.01, 0.06,],
            ['2010', 0.06, 0.32, 0.03, 0.26, 0.25, 0.04, 0.65, 1.07, 0.08, 0, 0.28, 0.02, 0.49, 0.06, 3.77, 0.89, 50.92, 0.49, 11.27, 0.22, 0.07, 97.36, 14.63, 0.17, 0, 0, 0, 0.05, 0.01, 0.07, 0.01, 0.06,],
            ['2011', 0.06, 0.37, 0.03, 0.25, 0.27, 0.03, 0.64, 1.06, 0.07, 0.01, 0.29, 0.02, 0.49, 0.05, 3.93, 1.01, 53.93, 0.51, 11.13, 0.22, 0.06, 104.72, 13.81, 0.16, 0, 0, 0, 0.05, 0.01, 0.06, 0.01, 0.06,],
            ['2012', 0.07, 0.38, 0.03, 0.28, 0.31, 0.03, 0.65, 1.06, 0.06, 0.01, 0.27, 0.02, 0.49, 0.07, 4.18, 1.21, 54.96, 0.54, 11.38, 0.23, 0.08, 113.51, 13.13, 0.14, 0, 0, 0, 0.06, 0.01, 0.06, 0.01, 0.06,],
            ['2013', 0.09, 0.47, 0.04, 0.29, 0.32, 0.04, 0.69, 1.19, 0.07, 0.01, 0.29, 0.02, 0.5, 0.06, 5.05, 1.35, 62.74, 0.6, 13.06, 0.31, 0.17, 135.42, 13.3, 0.16, 0, 0, 0, 0.05, 0.01, 0.07, 0.01, 0.06,],
            ['2014', 0.07, 0.6 , 0.03, 0.35, 0.39, 0.04, 0.8 , 1.3 , 0.08, 0.01, 0.34, 0.02, 0.52, 0.06, 5.39, 1.54, 70.7, 0.69, 14.1, 0.45, 0.35, 154., 12.8, 0.15, 0   , 0   , 0   , 0.06, 0.01, 0.07, 0.01, 0.05],
            ['2015', 0.07 , 0.6  , 0.04 , 0.33 , 0.36 , 0.04 , 0.75 , 1.2  , 0.07 , 0.01 , 0.28 , 0.02 , 0.5  , 0.08 , 5.25 , 1.55 , 70.94, 0.8  , 13.67, 0.47 , 0.51 , 155.2, 10.85, 0.13 , 0    , 0    , 0    , 0.06 , 0.01 , 0.07 , 0.01 , 0.06],
        ];
        $xs = [
            '2008' => 'accident_axis',
            '2009' => 'accident_axis',
